...
try {
    ...
    Write-Host "Browser smoke passed: local undo/redo/layout/recovery, node/edge/lane editing, edge inspector/viewer restrictions, members, model policy, cancel/timeout/conflict recovery, local P95 budget, persisted release lifecycle, asynchronous blueprint jobs/downloads, responsive widths, and browser errors."
}
finally {
